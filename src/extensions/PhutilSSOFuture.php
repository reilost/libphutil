...
final class PhutilSSOFuture extends FutureProxy {
  ...
  public function setRawSSOQuery($action, array $params = array()) {
    $this->action = $action;
    $this->params = $params;
    return $this;
  }
  ...
  protected function didReceiveResult($result) {
    ...
    try {
      ...
      throw new PhutilProxyException(
        pht('Expected JSON response from SSO.'),
        $ex);
    }

    return id(new PhutilSSOResponse())
      ->setStatus($status)
      ->setHeaders($headers)
      ->setBody($data);
  }
